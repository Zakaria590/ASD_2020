...
Noeud_t construitArbreEntierMysterieux (value_t i, value_t j) {
    ...
    if (i <= j) {
      ...
      AjouterFilsGauche(arbre,construitArbreEntierMysterieux(i,mediane-1));
      AjouterFilsDroit(arbre,construitArbreEntierMysterieux(mediane+1,j));
      return arbre;
    }
